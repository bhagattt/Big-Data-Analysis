...
| **Exp 3** | **MapReduce on Unstructured Text** | `exp3_mapreduce.py` | `data/renewable_energy_text.txt` | [EXPERIMENT_3_MANUAL.md](EXPERIMENT_3_MANUAL.md) | `screenshots/exp3_01_mapreduce_results.png` |
